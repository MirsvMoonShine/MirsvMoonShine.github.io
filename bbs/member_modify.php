...
<? if($group_data[use_home_address]) { ?> 
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=home_address size=40 maxlength=255 value="<?=$member[home_address]?>" style=border-color:#d8b3b3 class=input><input type=button value='검색' class=input style=border-color:#d8b3b3 onclick=zipcode('write','home_address')>
...
<? if($group_data[use_office_address]) { ?>
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=office_address size=40 maxlength=255 value="<?=$member[office_address]?>" style=border-color:#d8b3b3 class=input><input type=button value='검색' class=input style=border-color:#d8b3b3 onclick=zipcode('write','office_address'>
